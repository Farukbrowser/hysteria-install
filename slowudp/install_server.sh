...
# 
# Modify by 24clan - https://github.com/farukbrowser/hysteria-install
#
...
# URLs of GitHub
REPO_URL="https://github.com/farukbrowser/hysteria-install"
API_BASE_URL="https://api.github.com/repos/farukbrowser/hysteria-install"
...
rerun_with_sudo() {
  ...
  if has_prefix "$0" "/dev/fd/"; then
    ...
    if has_command curl; then
      curl -o "$_tmp_script" 'https://raw.githubusercontent.com/farukbrowser/hysteria-install/main/slowudp/install_server.sh'
    elif has_command wget; then
      wget -O "$_tmp_script" 'https://raw.githubusercontent.com/farukbrowser/hysteria-install/main/slowudp/install_server.sh'
    else
      return 127
    fi
