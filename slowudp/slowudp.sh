...
# https://github.com/farukbrowser/hysteria-install
#
...
askInstallHysteria(){
    read -rp "SlowUDP binary is closed source developed by 24clan, do you wish to continue install? [y/n]: " yn
...
installHysteria(){
    ...
    wget -N https://raw.githubusercontent.com/farukbrowser/hysteria-install/main/slowudp/install_server.sh
...
menu() {
    ...
    echo -e "# ${RED}https://github.com/farukbrowser/hysteria-install${PLAIN}                                   #"
    echo -e "# ${GREEN}Maintained By ${PLAIN}: 24clan                                                       #"
